...
export const Main = () => {
  return (
    <div className="bg-[url('/img/home.jpeg')] px-[20px] pt-[30px] pb-[60px] sm:pb-[100px]">
      <div className="max-w-[800px] mx-auto">
        <div className="flex items-end justify-between">
          <Image className="max-sm:w-[140px]" width={180} height={100} src="/svg/logo.svg" alt="" />
          <Link
            className="text-[16px] sm:text-[20px] font-bold text-white"
        ...
        <h1 className="mt-[40px] text-[20px] sm:text-[40px] text-white font-extrabold text-center">
          Licensed WA General Contractor
        </h1>
        <p className="text-white text-[18px] sm:text-[28px] text-center max-w-[700px] mx-auto">
          Extrerior construction, remodeling & property impovements for
          Washington homes
        </p>

        <div className="flex justify-center gap-[10px] mt-[40px] max-w-[480px] mx-auto">
          <Link href="#" className="p-button sm:flex-1">
            <span className="max-sm:hidden">Request</span> Free Estimate
          </Link>
          <Link
            href="#"
            className="!bg-white gap-[10px] !text-(--dark-blue) p-button sm:flex-1"
          >
            Call Now
        ...
        <ul className="flex flex-wrap gap-2 justify-center mt-[25px] text-[20px]">
          {["Licensed", "Bonded", "Insured", "Local Washington Contractor"].map(
            (t, i) => (
              <li
                className={`text-white text-[16px] sm:text-[18px] flex items-center ${
                  i === 0
                    ? `before:content-[''] 
                    before:bg-[url('/svg/star.svg')] 
                    before:bg-contain 
                    before:bg-no-repeat  
                    before:inline-block 
                    before:w-6 
